...
var $author$project$Snakey$ControlKey = function (a) {
	return {$: 'ControlKey', a: a};
};
var $author$project$Snakey$toKey = function (keyValue) {
...
var $author$project$Snakey$Down = {$: 'Down'};
var $author$project$Snakey$Left = {$: 'Left'};
var $author$project$Snakey$Position = F2(
	function (xPos, yPos) {
		return {xPos: xPos, yPos: yPos};
	});
var $author$project$Snakey$Right = {$: 'Right'};
var $author$project$Snakey$Up = {$: 'Up'};
...
var $author$project$Snakey$crash = function (model) {
	var actualSnake = A2($elm$core$Maybe$withDefault, _List_Nil, model.snake);
	var head = A2(
		$elm$core$Maybe$withDefault,
		A2($author$project$Snakey$Position, -10, -10),
	...
	var tail = A2(
		...
		$elm$core$List$tail(actualSnake));
	return ((head.xPos < 5) || ((head.xPos > 995) || ((head.yPos < 5) || ((head.yPos > 595) || A2($elm$core$List$member, head, tail))))) ? true : false;
};
var $author$project$Snakey$GotNewDirection = function (a) {
...
var $author$project$Snakey$directionGenerator = A2(
	$elm$random$Random$uniform,
	$author$project$Snakey$Up,
	_List_fromArray(
		[$author$project$Snakey$Down, $author$project$Snakey$Left, $author$project$Snakey$Right]));
...
var $author$project$Snakey$GotNewPosition = function (a) {
	return {$: 'GotNewPosition', a: a};
};
...
var $author$project$Snakey$numCols = 100;
var $author$project$Snakey$numRows = 60;
var $author$project$Snakey$positionGenerator = A3(
	$elm$random$Random$map2,
	F2(
		function (xPos, yPos) {
			return A2($author$project$Snakey$Position, xPos, yPos);
		}),
	A2($elm$random$Random$int, 4, $author$project$Snakey$numCols - 4),
	A2($elm$random$Random$int, 4, $author$project$Snakey$numRows - 4));
var $author$project$Snakey$getPositionCmd = A2($elm$random$Random$generate, $author$project$Snakey$GotNewPosition, $author$project$Snakey$positionGenerator);
var $author$project$Snakey$GotSnakeHead = function (a) {
...
var $author$project$Snakey$snakePos = F3(
	function (model, position, section) {
		...
		if (_v0.$ === 'Just') {
			...
			return A2($author$project$Snakey$Position, ((position.xPos * $author$project$Snakey$square) + $author$project$Snakey$square) + $author$project$Snakey$thingRadius, (position.yPos * $author$project$Snakey$square) + $author$project$Snakey$thingRadius);
		}
	});
		...
		return $elm$core$Maybe$Just(
			_List_fromArray(
				[
					...
					A3($author$project$Snakey$snakePos, model, position, 1),
					A3($author$project$Snakey$snakePos, model, position, 2)
				]));
	});
...
var $author$project$Snakey$moveySnakey = F2(
	function (direction, snake) {
		...
		var newHead = function () {
			switch (direction.$) {
				case 'Up':
					return A2($author$project$Snakey$Position, h.xPos, h.yPos - $author$project$Snakey$square);
				case 'Down':
					return A2($author$project$Snakey$Position, h.xPos, h.yPos + $author$project$Snakey$square);
				case 'Left':
					return A2($author$project$Snakey$Position, h.xPos - $author$project$Snakey$square, h.yPos);
				default:
					return A2($author$project$Snakey$Position, h.xPos + $author$project$Snakey$square, h.yPos);
			}
		}();
...
var $author$project$Snakey$snack = function (model) {
	var actualSnake = A2($elm$core$Maybe$withDefault, _List_Nil, model.snake);
	var actualFood = A2(
		$elm$core$Maybe$withDefault,
		A2($author$project$Snakey$Position, -10, -10),
...
var $author$project$Snakey$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Tick':
				...
				if (_v2) {
					if (snacked) {
						return _Utils_Tuple2(
							...
							$author$project$Snakey$getPositionCmd);
					} else {
						return _Utils_Tuple2(
							_Utils_update(
								model,
			...
			case 'StartGame':
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[$author$project$Snakey$getPositionCmd, $author$project$Snakey$getDirectionCmd, $author$project$Snakey$getSnakeHeadCmd])));
			case 'GotNewPosition':
				var position = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							food: $elm$core$Maybe$Just(
								A2($author$project$Snakey$Position, ((position.xPos * $author$project$Snakey$square) + $author$project$Snakey$square) + $author$project$Snakey$thingRadius, (position.yPos * $author$project$Snakey$square) + $author$project$Snakey$thingRadius))
						}),
					$elm$core$Platform$Cmd$none);
			case 'GotSnakeHead':
				var position = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							snake: A2($author$project$Snakey$initSnake, model, position)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var direction = msg.a;
...
var $author$project$Snakey$StartGame = {$: 'StartGame'};
...
var $author$project$Snakey$drawThing = F2(
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$core$String$fromInt(position.xPos)),
							$elm$svg$Svg$Attributes$cy(
							$elm$core$String$fromInt(position.yPos)),
							$elm$svg$Svg$Attributes$r(
							$elm$core$String$fromInt($author$project$Snakey$thingRadius + 2)),
					...
					_List_fromArray(
						[
							...
							$elm$core$String$fromInt(position.yPos)),
							$elm$svg$Svg$Attributes$r(
							$elm$core$String$fromInt($author$project$Snakey$thingRadius)),
							$elm$svg$Svg$Attributes$fill(colour)
						]),
					_List_Nil)
				]));
...
var $author$project$Snakey$snakeColour = 'red';
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$core$String$fromInt($author$project$Snakey$width)),
								$elm$svg$Svg$Attributes$height(
								$elm$core$String$fromInt($author$project$Snakey$height)),
								$elm$svg$Svg$Attributes$viewBox(
								'0 0 ' + ($elm$core$String$fromInt($author$project$Snakey$width) + (' ' + $elm$core$String$fromInt($author$project$Snakey$height))))
							]),
						_List_fromArray(
							[
								A2(
								...
								A2(
								$author$project$Snakey$drawThing,
								$author$project$Snakey$foodColour,
								A2(
									$elm$core$Maybe$withDefault,
									A2($author$project$Snakey$Position, 0, 0),
									model.food)),
								A2(
								$elm$svg$Svg$g,
								_List_Nil,
								A2(
									$elm$core$List$map,
									$author$project$Snakey$drawThing($author$project$Snakey$snakeColour),
									A2($elm$core$Maybe$withDefault, _List_Nil, model.snake)))
							]))
					]))
			]));
};
var $author$project$Snakey$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return _Utils_Tuple2($author$project$Snakey$initialModel, $elm$core$Platform$Cmd$none);
		},
		subscriptions: $author$project$Snakey$subscriptions,
		update: $author$project$Snakey$update,
		view: $author$project$Snakey$view
	});
_Platform_export({'Snakey':{'init':$author$project$Snakey$main(
