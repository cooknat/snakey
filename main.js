...
var author$project$Main$toKey = function (keyValue) {
	var _n0 = elm$core$String$uncons(keyValue);
	if ((_n0.$ === 'Just') && (_n0.a.b === '')) {
		var _n1 = _n0.a;
		var _char = _n1.a;
...
var author$project$Main$crash = function (model) {
...
var author$project$Main$directionGenerator = A2(
	elm$random$Random$uniform,
	author$project$Main$Up,
	_List_fromArray(
		[author$project$Main$Down, author$project$Main$Left, author$project$Main$Right]));
...
var author$project$Main$getDirectionCmd = A2(elm$random$Random$generate, author$project$Main$GotNewDirection, author$project$Main$directionGenerator);
var author$project$Main$GotNewPosition = function (a) {
	return {$: 'GotNewPosition', a: a};
};
var author$project$Main$numCols = 100;
var author$project$Main$numRows = 60;
...
var author$project$Main$positionGenerator = A3(
	...
	F2(
		function (xPos, yPos) {
			return A2(author$project$Main$Position, xPos, yPos);
		}),
	A2(elm$random$Random$int, 4, author$project$Main$numCols - 4),
	A2(elm$random$Random$int, 4, author$project$Main$numRows - 4));
var author$project$Main$getPositionCmd = A2(elm$random$Random$generate, author$project$Main$GotNewPosition, author$project$Main$positionGenerator);
var author$project$Main$GotSnakeHead = function (a) {
	return {$: 'GotSnakeHead', a: a};
};
var author$project$Main$getSnakeHeadCmd = A2(elm$random$Random$generate, author$project$Main$GotSnakeHead, author$project$Main$positionGenerator);
var author$project$Main$square = 10;
	...
	function (model, position, section) {
		...
		if (_n0.$ === 'Just') {
			switch (_n0.a.$) {
				case 'Up':
					var _n1 = _n0.a;
					return A2(author$project$Main$Position, (position.xPos * author$project$Main$square) + author$project$Main$thingRadius, ((position.yPos * author$project$Main$square) - (section * author$project$Main$square)) + author$project$Main$thingRadius);
				case 'Down':
					var _n2 = _n0.a;
					return A2(author$project$Main$Position, (position.xPos * author$project$Main$square) + author$project$Main$thingRadius, ((position.yPos * author$project$Main$square) + (section * author$project$Main$square)) + author$project$Main$thingRadius);
				case 'Left':
					var _n3 = _n0.a;
					return A2(author$project$Main$Position, ((position.xPos * author$project$Main$square) - (section * author$project$Main$square)) + author$project$Main$thingRadius, (position.yPos * author$project$Main$square) + author$project$Main$thingRadius);
				default:
					var _n4 = _n0.a;
					return A2(author$project$Main$Position, ((position.xPos * author$project$Main$square) + (section * author$project$Main$square)) + author$project$Main$thingRadius, (position.yPos * author$project$Main$square) + author$project$Main$thingRadius);
			}
		} else {
			return A2(author$project$Main$Position, ((position.xPos * author$project$Main$square) + author$project$Main$square) + author$project$Main$thingRadius, (position.yPos * author$project$Main$square) + author$project$Main$thingRadius);
		}
	});
var author$project$Main$initSnake = F2(
	function (model, position) {
		return elm$core$Maybe$Just(
			_List_fromArray(
				[
					A2(author$project$Main$Position, (position.xPos * author$project$Main$square) + author$project$Main$thingRadius, (position.yPos * author$project$Main$square) + author$project$Main$thingRadius),
					A3(author$project$Main$snakePos, model, position, 1),
					A3(author$project$Main$snakePos, model, position, 2)
				]));
	});
					...
					case 'i':
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									direction: elm$core$Maybe$Just(author$project$Main$Up)
								}),
							elm$core$Platform$Cmd$none);
					case 'j':
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									direction: elm$core$Maybe$Just(author$project$Main$Left)
								}),
							elm$core$Platform$Cmd$none);
					case 'k':
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									direction: elm$core$Maybe$Just(author$project$Main$Right)
								}),
							elm$core$Platform$Cmd$none);
					case 'm':
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									direction: elm$core$Maybe$Just(author$project$Main$Down)
								}),
							elm$core$Platform$Cmd$none);
					default:
						return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
			...
			case 'StartGame':
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[author$project$Main$getPositionCmd, author$project$Main$getDirectionCmd, author$project$Main$getSnakeHeadCmd])));
			case 'GotNewPosition':
				var position = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							food: elm$core$Maybe$Just(
								A2(author$project$Main$Position, ((position.xPos * author$project$Main$square) + author$project$Main$square) + author$project$Main$thingRadius, (position.yPos * author$project$Main$square) + author$project$Main$thingRadius))
						}),
					elm$core$Platform$Cmd$none);
			case 'GotSnakeHead':
				var position = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							snake: A2(author$project$Main$initSnake, model, position)
						}),
					elm$core$Platform$Cmd$none);
			default:
				var direction = msg.a;
...
var author$project$Main$drawThing = F2(
				...
				[
					...
					_List_fromArray(
						[
							...
							elm$core$String$fromInt(author$project$Main$thingRadius + 2)),
					...
					_List_fromArray(
						[
							...
							elm$core$String$fromInt(position.yPos)),
							elm$svg$Svg$Attributes$r(
							elm$core$String$fromInt(author$project$Main$thingRadius)),
							elm$svg$Svg$Attributes$fill(colour)
						]),
					_List_Nil)
				]));
	});
var author$project$Main$foodColour = 'yellow';
